...
| `S-19` | Distinct empty states for "no swimmers match these filters" and "no search results" | should | `done` | `mobile.no_matches` (needs adding server-side) vs `mobile.no_search_results` (idem) — see T-05 |
